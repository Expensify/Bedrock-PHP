...
class Client implements LoggerAwareInterface
{
    ...
    /**
     * @var ?string Extra log param to add to bedrock requests.
     */
    private $logParam;
     ...
     *                      int|string           logParam            An extra log to add in the bedrock request. Usually used for emails.
     *
     * @throws BedrockError
     */
